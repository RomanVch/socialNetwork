...
<nav className={style.navigation}>
            <ul className={style.ul}>
                <li  className={style.list}><NavLink activeClassName={style.activeNav} className={style.list_link} to = "/maps"><svg version="1.1" viewBox="0 0 99.313 99.313">
                    <g>
		...
		c0.005,0,0.011,0,0.016,0c0.512,0,0.987-0.263,1.259-0.697l7.752-12.4L91.697,83.4H70.791z"/>
                ...
                <li className={style.list}><NavLink  activeClassName={style.activeNav} className={style.list_link} to = "/balance"><svg viewBox="0 0 100.355 100.352" >
                    <g>
		...
		H87.8V32.676c0-0.829-0.671-1.5-1.5-1.5H23.109v-5.848h69.85L92.959,62.063L92.959,62.063z"/>
                ...
                <li className={style.list}><NavLink  activeClassName={style.activeNav} className={style.list_link} to = "/profile"><svg viewBox="0 0 24 24">
                    <g>
